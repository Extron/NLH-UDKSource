/*******************************************************************************
	Wp_S_CollapsibleStock

	Creation date: 12/09/2013 01:15
	Copyright (c) 2013, Trystan
	<!-- $Id: NewClass.uc,v 1.1 2004/03/29 10:39:26 elmuerte Exp $ -->
*******************************************************************************/

class Wp_S_CollapsibleStock extends Wp_Stock;

defaultproperties
{
	Begin Object Name=FirstPersonMesh
		SkeletalMesh=SkeletalMesh'CollapsableStock.Meshes.CollapsableStockMesh'
	End Object
	...
	ComponentName="Collapsible Stock"
